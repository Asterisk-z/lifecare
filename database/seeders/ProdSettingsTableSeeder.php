...
class ProdSettingsTableSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('settings')->insert([
            ['setting_name'     => 'business_type',                 'setting_value'   =>'health'],
            ...
            ['setting_name'     => 'currency_symbol',               'setting_value'   => 'N'],
            ...
            ['setting_name'     => 'app_name',                      'setting_value'   => 'Life Care'],
            ['setting_name'     => 'app_logo',                      'setting_value'   => 'default-logo.png'],
            ['setting_name'     => 'currency_code',                 'setting_value'   => 'ngn'],
//            ['setting_name'     => 'purchase_code',                 'setting_value'   => ''],
            ...
            ['setting_name'     => 'landing_page_header',           'setting_value'   =>'Health Care'],
            ['setting_name'     => 'company_name',                  'setting_value'   =>'Demo Company Name'],
            ['setting_name'     => 'copyright_text',                'setting_value'   =>'Copyright @ 2023 by Life Care'],
